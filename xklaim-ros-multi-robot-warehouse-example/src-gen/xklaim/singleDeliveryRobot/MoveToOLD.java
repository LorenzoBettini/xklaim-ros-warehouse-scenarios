...
public class MoveToOLD extends KlavaProcess {
  ...
  public MoveToOLD(final String robotId, final Double x, final Double y) {
  ...
  public void executeProcess() {
    try {
      ...
      final Twist intialMovement = new Twist();
      intialMovement.linear.x = (-0.3);
      pub.publish(intialMovement);
      Thread.sleep(500);
