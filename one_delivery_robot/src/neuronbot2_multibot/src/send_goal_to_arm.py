...
def move_robot_arm(joint_values):
  ...
  arm_goal.trajectory.joint_names = ['shoulder_pitch_joint', 'elbow_roll_joint','elbow_pitch_joint' ,'wrist_roll_joint', 'wrist_pitch_joint', 'gripper_roll_joint']
...
if __name__ == '__main__':
  ...
  try:
    ...
    move_robot_arm([-0.1, 0.5, 0.02, 0, 0, 0])
